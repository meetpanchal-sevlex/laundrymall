  ...
  return (
    <div className="flex flex-col bg-[#F4F6FA] pb-16 md:pb-4">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="md:hidden px-3 py-1.5 bg-white border-b border-gray-100">
          <div className="flex items-center bg-gray-50 border border-gray-200/90 rounded-full px-3 py-1 gap-2 shadow-[inset_0_1px_2px_rgba(0,0,0,0.02)] focus-within:border-blue-500 focus-within:bg-white transition-all">
            <Search className="w-3.5 h-3.5 text-blue-600 flex-shrink-0" />
            <SearchAutocomplete
              isMobile
              placeholder="Search 160+ products, machinery, chemicals..."
            />
          </div>
        </div>
